      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            Sign in to Terms Watcher
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Analyze terms and conditions with AI-powered insights
          </p>
        </div>
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded">
            <p className="text-sm">
              ...
              {error === 'OAuthAccountNotLinked' && 'Another account with the same email address already exists.'}
              {error === 'EmailSignin' && 'Unable to send email.'}
